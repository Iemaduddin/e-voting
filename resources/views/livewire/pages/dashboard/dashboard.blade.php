...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-indigo-600">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 mb-1">Total Pemilihan</p>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-600">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 mb-1">Pemilihan Aktif</p>
                    <h3 class="text-3xl font-bold text-gray-900">0</h3>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-600">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 mb-1">Total Kandidat</p>
                    <h3 class="text-3xl font-bold text-gray-900">0</h3>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-orange-600">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 mb-1">Total Suara</p>
                    <h3 class="text-3xl font-bold text-gray-900">0</h3>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 class="text-2xl font-bold text-gray-900 mb-2">Selamat Datang di Dashboard E-Voting!</h2>
        <p class="text-gray-600">Kelola sistem pemilihan elektronik Anda dengan mudah dan efisien.</p>
    </div>

    <!-- Quick Actions -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @if (auth()->user()->hasRole('super admin') || auth()->user()->hasRole('organization'))
            ...
            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900">Lihat Hasil</h3>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300">
            ...
            <p class="text-gray-600 text-sm mb-4">Unduh laporan lengkap pemilihan dan analisis data.</p>
