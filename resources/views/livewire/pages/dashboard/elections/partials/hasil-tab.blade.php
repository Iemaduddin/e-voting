<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 text-sm">
            <div class="flex items-center gap-2 text-gray-600 whitespace-nowrap">
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <div class="space-y-4">
                @foreach ($candidatesWithVotes as $index => $item)
                    ...
                    @endphp
                    <div
                        class="relative border-2 {{ $borderColor }} rounded-xl p-4 {{ $isWinner ? 'shadow-lg bg-gradient-to-r from-amber-50 to-yellow-50' : 'shadow-sm' }} transition-all duration-300 hover:shadow-md">
                        @if ($isWinner)
                            <div class="absolute -top-3 -right-3">
                                <div class="bg-gradient-to-r from-amber-400 to-yellow-500 rounded-full p-2 shadow-lg">
                        ...
                        <div class="flex items-center justify-between mb-3">
                            <div class="flex items-center gap-3 flex-1 min-w-0">
                                <span
                                    class="inline-flex items-center justify-center w-10 h-10 flex-shrink-0 rounded-full bg-gradient-to-r {{ $color }} text-white text-lg font-bold shadow-md">
                                    {{ $index + 1 }}
                                </span>
                                ...
                                <div class="flex items-center gap-2 flex-shrink-0">
                                    ...
                                    @else
                                        <div
                                            class="w-12 h-12 rounded-full bg-gradient-to-br from-purple-400 to-pink-400 flex items-center justify-center border-2 border-white shadow-md text-white font-bold">
                                    ...
                                    @if ($item['candidate']->wakil && $wakilPhoto)
                                        <img src="{{ asset('storage/' . $wakilPhoto) }}"
                                            ...
                                            class="w-12 h-12 rounded-full object-cover border-2 border-white shadow-md -ml-3">
                                    @elseif ($item['candidate']->wakil)
                                        <div
                                            class="w-12 h-12 rounded-full bg-gradient-to-br from-blue-400 to-indigo-400 flex items-center justify-center border-2 border-white shadow-md -ml-3 text-white font-bold">
                                ...
                                <div class="min-w-0 flex-1">
                                    <p
                                        class="text-base font-bold text-gray-900 {{ $isWinner ? 'text-lg' : '' }} truncate">
                            ...
                            <div class="text-right flex-shrink-0 ml-4">
                                ...
                                <p class="text-xs text-gray-500">dari total pemilih</p>
                            </div>
                        </div>
                ...
                <!-- Golput Card -->
                <div class="border-2 border-red-200 rounded-xl p-4 bg-gradient-to-r from-red-50 to-pink-50 shadow-sm">
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center gap-3">
                            <span
                                class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-r from-red-500 to-red-600 text-white shadow-md">
                            ...
                            <div>
                                <p class="text-base font-bold text-gray-900">Golongan Putih</p>
                                <p class="text-xs text-gray-500 mt-0.5">Tidak memilih</p>
                            </div>
                        </div>
                        <div class="text-right">
                            <p class="text-2xl font-bold text-red-600">{{ $golputRate }}%</p>
                            <p class="text-xs text-gray-500">{{ $golput }} orang</p>
                        </div>
                    </div>

                    <div class="relative w-full h-8 bg-gray-200 rounded-full overflow-hidden">
                        <div class="absolute inset-y-0 left-0 bg-gradient-to-r from-red-500 to-red-600 rounded-full transition-all duration-500 ease-out flex items-center justify-end pr-3"
