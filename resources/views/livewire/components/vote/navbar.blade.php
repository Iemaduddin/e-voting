    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <a href="{{ route('vote.index') }}" wire:navigate class="flex items-center space-x-3 flex-shrink-0">
                ...
                <div>
                    <span class="text-xl font-bold text-blue-700">E-Voting</span>
            ...
            <div class="flex items-center">
                <div class="hidden md:block">
                    <x-dropdown align="right" width="56">
                        <x-slot name="trigger">
                            <button
                                class="flex items-center px-3 py-2 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-100 focus:outline-none transition-all duration-200 border border-transparent hover:border-blue-200 shadow-sm hover:shadow-md">
                                <div
                        ...
                        <x-slot name="content">
                            ...
                            <!-- Menu Items -->
                            <div class="py-2">
                                @hasanyrole('Super Admin|Organization')
                                    <x-dropdown-link :href="route('profile')" wire:navigate
                                        class="flex items-center px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-100 transition duration-150">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium">Dashboard Admin</p>
                                            <p class="text-xs text-gray-500">Kelola Pemilihan</p>
                                        </div>
                                    </x-dropdown-link>
                                @endhasanyrole
                                <x-dropdown-link :href="route('profile')" wire:navigate
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden md:hidden border-t border-gray-200 bg-white">
        <div class="pt-4 pb-3 border-t border-gray-200">
            <div class="flex items-center px-4 mb-3">
                <div class="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mr-3 shadow-lg">
            ...
            <div class="space-y-1 px-2">
                ...
                <a href="{{ route('profile') }}" wire:navigate
                    class="flex items-center px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-blue-50 transition duration-150">
                ...
                <button wire:click="logout"
                    class="w-full flex items-center px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-red-50 transition duration-150">
